---
title: "Whitepaper"
description: "Fianza: uncollateralized credit for autonomous agents, underwritten by verifiable revenue on Stellar. Read online or download the PDF."
---
...
<CardGroup cols={2}>
  <Card title="Download PDF" icon="file-arrow-down" href="/fianza-whitepaper.pdf">
    11 pages, typeset. Right-click to save.
  </Card>
...
<iframe
  src="/fianza-whitepaper.pdf"
  title="Fianza whitepaper"
  style={{
    width: "100%",
    height: "820px",
...
<Note>
No PDF viewer? [Download it directly](/fianza-whitepaper.pdf). The full text is
also below, and is the same document.
</Note>
