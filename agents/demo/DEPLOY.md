...
- **Env vars:**
  ...
  - `DEMO_HOLDING_PUBLIC` = `GCYTUI46TG2CGOGRC73VBD56KIIQHE46EKZ57SUQGZXHRE6MEXWXMMUI`
  - `TRUSTLINE_API` = `https://trustline-rpxt.onrender.com`  *(the LIVE backend)*
  - `DEMO_RESEARCH_URL` = `https://trustline-data-seller.onrender.com/research`
...
| CNAME | `data` | `trustline-data-seller.onrender.com` |
...
```bash
curl https://trustline-data-seller.onrender.com/health      # {ok:true,...}
